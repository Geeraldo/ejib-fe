  ...
  return (
    <div className="col-span-full xl:col-span-8 bg-white shadow-lg rounded-sm border border-slate-200">
      <header className="px-5 py-4 border-b border-slate-100">
        <h2 className="font-semibold text-slate-800">Total Pendapatan</h2>
      </header>
      <div className="p-3">
        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
              <tr>
                <th className="p-2">
                  <div className="font-semibold text-left">Gereja</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Saldo</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Pemasukan</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Pengeluaran</div>
                </th>
              </tr>
            </thead>
            {/* Table body */}
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Imanuel Bahu</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">Rp. 220.000.0000</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-green-500">Rp 12.000.0000</div>
                </td>
                <td className="p-2">
                  <div className="text-center">Rp 35.000.0000</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Sobat Kristus</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">Rp 50.000.000</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-green-500">Rp 7.000.0000</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Bukit Karmel </div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">Rp 34.000.000</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-green-500">Rp 22.000.0000</div>
                </td>
                <td className="p-2">
                  <div className="text-center">Rp 42.000.000</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Musafir Kleak</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">Rp 32.000.000</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-green-500">Rp 22.000.000</div>
                </td>
                <td className="p-2">
                  <div className="text-center">Rp 42.000.000</div>
                </td>
