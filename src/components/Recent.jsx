            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900" href="#0">Imanuel Bahu  </a>Pemasukan<a className="font-medium text-slate-800" href="#0"> Rp. 10.000.000 </a> Derma Bulan Oktober</div>
